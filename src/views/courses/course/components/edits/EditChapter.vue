  ...
  >
    ...
    >
      <el-form-item
        ...
        label="Course title"
      >
        <el-input v-model="chapterEditForm.chapterTitle"></el-input>
      </el-form-item>
      ...
      >
        <el-input v-model="chapterEditForm.chapterDescription"></el-input>
      </el-form-item>
    </el-form>
...
import { editChapter, editCourseInfo } from "@/api/courses";
export default {
  data() {
    return {
      chapterEditForm: {
